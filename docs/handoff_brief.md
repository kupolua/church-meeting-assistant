...
⚠️ **Рік зберігання — обіцянка, якої `cloud_plan` §2 ще не дає.** Церква, що виходить,
має знати, що її записи лишаються рік. Сказати це треба до того, як хтось покладеться.
