...
**9. Запрошення для звичайних акаунтів** — S
...
**Регресійний набір:** `uv run python tests/mt_phase3_smoke.py` — 133 перевірки, sandbox `cma_mt3`.
