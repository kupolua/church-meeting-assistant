...
+ 9 нових перевірок у `tests/mt_phase3_smoke.py` (**89 разом**, було 80): парсинг часу, прилипання
до репліки, віднімання вікна в RTTM, «Присутні» попри 30 с, редагованість збереженого рядка,
крос-tenant 404, відкат до оригіналу. Останній повний прогін — 24 серпня, усі 89 PASS.
...
**Регресійний набір:** `uv run python tests/mt_phase3_smoke.py` — 89 перевірок, sandbox `cma_mt3`.
